...
/**
 * 
 * CsmtBizBureauOperation2511ExceptionHandler is a controller advice which captures any of the exceptions in the process of api execution.
 *
 */
@ControllerAdvice
public class CsmtBizBureauOperation2511ExceptionHandler extends ResponseEntityExceptionHandler{

	private static final Logger log = LoggerFactory.getLogger(CsmtBizBureauOperation2511ExceptionHandler.class);
	...
	/**
	 * CsmtBizBureauOperation2511Exception handler
	 * @param CsmtBizBureauOperation2511Exception
	 * @param request
	 * @return
	 */
	@ExceptionHandler(value = { CsmtBizBureauOperation2511Exception.class })
	protected ResponseEntity<Object> handleRequestException(CsmtBizBureauOperation2511Exception exception, WebRequest request) {
		// build header responses
		final HttpHeaders httpHeaders = getResponseHeaders(request);
